...
<?php
$no=0;
    $viewlist_query=mysqli_query($conn, "SELECT * FROM `staff_tab` WHERE staff_id!='$s_staff_id' AND status_id='ACT'");
...
?>
                   ...
                   <div class="staff-list-proper">
                       ...
                       <p> STATUS: <span class="staff-id"><?php echo ($status_id) ?></span></p>
                       <div class="buttons">
